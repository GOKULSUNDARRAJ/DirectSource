...
import static com.example.milestoneui.ItemClass.LayoutOne;
import static com.example.milestoneui.ItemClass.LayoutTwo;
...
public class AdapterClass extends RecyclerView.Adapter {
    ...
    class LayoutTwoViewHolder
        ...
        public LayoutTwoViewHolder(@NonNull View itemView)
        {
            ...
            text_one = itemView.findViewById(R.id.textView2);
            text_two = itemView.findViewById(R.id.textView3);
            linearLayout
                    = itemView.findViewById(R.id.linearlayout);
        }
