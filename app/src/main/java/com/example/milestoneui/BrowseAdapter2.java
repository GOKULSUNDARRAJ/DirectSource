...
public class BrowseAdapter2 extends RecyclerView.Adapter<BrowseAdapter2.BrowseViewHolder> {
    ...
    public BrowseAdapter2(Context context, List<BrowseItem> itemList, FragmentManager fragmentManager) {
    ...
    public static class BrowseViewHolder extends RecyclerView.ViewHolder {
        ...
        public BrowseViewHolder(@NonNull View itemView) {
            ...
            textView = itemView.findViewById(R.id.itemText2);
