...
public class SwapAdapter extends RecyclerView.Adapter<SwapAdapter.ViewHolder> {
    ...
    public SwapAdapter(Context context, List<SwapItem> itemList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.relatedlist, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        SwapItem swapItem = itemList.get(position);
        // Bind data to views in the item_cardview layout
        holder.itemText.setText(swapItem.getItemText());
        holder.itemImage.setImageResource(swapItem.getImageResource());
